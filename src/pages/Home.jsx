...
const Home = () => {
  return (
    <div className="max-w-[1300px] ml-8 flex flex-col justify-end gap-10 max-[621px]:gap-0 min-[1605px]:pt-[400px] min-[1226px]:pt-[280px] min-[855px]:pt-[130px] max-[655px]:ml-0 min-[621px]:pt-[80px] min-[300px]:pt-[70px]">
